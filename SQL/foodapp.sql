...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2020 at 04:17 PM
...
CREATE TABLE `users` (
  ...
  `lat` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lang` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_open` int(11) DEFAULT NULL COMMENT '1 = Yes , 2 = No',
...
INSERT INTO `users` (`id`, `name`, `email`, `mobile`, `profile_image`, `password`, `type`, `tax`, `delivery_charge`, `lat`, `lang`, `is_open`, `token`, `is_available`, `created_at`, `updated_at`) VALUES
(1, 'Admin', 'admin@gmail.com', '', 'profile-5ee90c4cdce2c.jpg', '$2y$10$k5hFRqBwGwnZA.sYftjui.MBuXmcdEg/agFI.owFAeZpbhdPY.kFC', 1, '18', '100', '21.278581', '72.9753812', 1, 'foUMSygnRN-FY7UL7bj9o5:APA91bGzcFEMDAUVfFL2UjeVoBihXlUXfTojGn6UcwSRiVhHonhw7TXUgI-Mq2zq0wUeBtiIkn7Gi6qPS_S4grn7C9bF4IxsP23hbs1B5jCjnl--6Aa_bK_OARj1Hb6drtCM7gb1MahS', 1, '2020-06-05 07:21:20', '2020-08-23 08:29:12');
